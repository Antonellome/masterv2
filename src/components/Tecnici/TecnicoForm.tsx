            ...
            <DialogContent sx={{ pt: '20px !important', pb: '20px !important' }}>
                <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale="it">
                    ...
                    <FormSection title="Accesso App e Recapiti">
                        <Grid xs={12} sm={6}><TextField name="email" label="Email" value={formData.email || ''} onChange={handleChange} fullWidth required/></Grid>
                        <Grid xs={12} sm={6}><TextField name="telefono" label="Telefono" value={formData.telefono || ''} onChange={handleChange} fullWidth /></Grid>
                        ...
                        <Grid xs={12}><TextField name="indirizzo" label="Indirizzo" value={formData.indirizzo || ''} onChange={handleChange} fullWidth /></Grid>
                        <Grid xs={12} sm={5}><TextField name="citta" label="Città" value={formData.citta || ''} onChange={handleChange} fullWidth /></Grid>
                        <Grid xs={12} sm={3}><TextField name="provincia" label="Provincia" value={formData.provincia || ''} onChange={handleChange} fullWidth inputProps={{ maxLength: 2 }} /></Grid>
                        <Grid xs={12} sm={4}><TextField name="cap" label="CAP" value={formData.cap || ''} onChange={handleChange} fullWidth /></Grid>
                    </FormSection>
                    ...
                    <FormSection title="Documenti e Scadenze">
                        <Grid xs={12} md={6}><TextField name="codiceFiscale" label="Codice Fiscale" value={formData.codiceFiscale || ''} onChange={handleChange} fullWidth /></Grid>
                        <Grid xs={12} md={6}></Grid> {/* Spacer */}
                        <Grid xs={12} md={6}><TextField name="numeroCartaIdentita" label="Numero Carta Identità" value={formData.numeroCartaIdentita || ''} onChange={handleChange} fullWidth /></Grid>
                        {renderDatePicker("Scadenza Carta Identità", 'scadenzaCartaIdentita')}
                        <Grid xs={12} md={6}><TextField name="numeroPassaporto" label="Numero Passaporto" value={formData.numeroPassaporto || ''} onChange={handleChange} fullWidth /></Grid>
                        {renderDatePicker("Scadenza Passaporto", 'scadenzaPassaporto')}
                        <Grid xs={12} md={4}><TextField name="numeroPatente" label="Numero Patente" value={formData.numeroPatente || ''} onChange={handleChange} fullWidth /></Grid>
                        <Grid xs={12} md={2}><TextField name="categoriaPatente" label="Cat. Patente" value={formData.categoriaPatente || ''} onChange={handleChange} fullWidth /></Grid>
                        {renderDatePicker("Scadenza Patente", 'scadenzaPatente')}
                        <Grid xs={12} md={6}><TextField name="numeroCQC" label="Numero CQC" value={formData.numeroCQC || ''} onChange={handleChange} fullWidth /></Grid>
                    ...
                    <FormSection title="Formazione e Sicurezza">
                     ...
                     <FormSection title="Note">
                        <Grid xs={12}><TextField name="note" label="Note generali sul tecnico" value={formData.note || ''} onChange={handleChange} fullWidth multiline rows={4} /></Grid>
                    </FormSection>
