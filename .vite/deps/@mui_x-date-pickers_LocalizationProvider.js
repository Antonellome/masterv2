...
var MuiPickersAdapterContext = React40.createContext(null);
if (true) {
...
var LocalizationProvider = function LocalizationProvider2(inProps) {
  ...
  } = React40.useContext(MuiPickersAdapterContext) ?? {
    utils: void 0,
    localeText: void 0
  };
  ...
  const localeText = React40.useMemo(() => _extends({}, themeLocaleText, parentLocaleText, inLocaleText), [themeLocaleText, parentLocaleText, inLocaleText]);
  const utils = React40.useMemo(() => {
    if (!DateAdapter) {
      if (parentUtils) {
        return parentUtils;
      }
...
`));
  ...
  const defaultDates = React40.useMemo(() => {
    if (!utils) {
      return null;
    }
    return {
  ...
  return (0, import_jsx_runtime19.jsx)(MuiPickersAdapterContext.Provider, {
    value: contextValue,
    children
  });
};
